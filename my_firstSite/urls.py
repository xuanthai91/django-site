"""my_firstSite URL Configuration
...
urlpatterns = [
    ...
    url(r'^board/(?P<pk>\d+)/topics/(?P<topic_pk>\d+)/posts/(?P<post_pk>\d+)/edit/$', views.PostUpdateViews.as_view(), name='edit_post'),
